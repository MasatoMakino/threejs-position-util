...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _bin_threejs_position_util__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../bin/threejs-position-util */ \"./bin/threejs-position-util.js\");\n/* harmony import */ var three__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! three */ \"./node_modules/three/build/three.module.js\");\n\n\nvar W = 1920;\nvar H = 1080;\n\nvar onDomContentsLoaded = function onDomContentsLoaded() {\n  // シーンを作成\n  var scene = new three__WEBPACK_IMPORTED_MODULE_1__[\"Scene\"]();\n  var camera = new three__WEBPACK_IMPORTED_MODULE_1__[\"PerspectiveCamera\"](45, W / H, 1, 10000);\n  camera.position.set(0, 0, 1000);\n  scene.add(camera);\n  var renderOption = {\n    canvas: document.getElementById(\"webgl-canvas\"),\n    antialias: true\n  };\n  var renderer = new three__WEBPACK_IMPORTED_MODULE_1__[\"WebGLRenderer\"](renderOption);\n  renderer.setClearColor(new three__WEBPACK_IMPORTED_MODULE_1__[\"Color\"](0x000000));\n  renderer.setSize(W, H);\n  renderer.setPixelRatio(window.devicePixelRatio);\n  var geo = new three__WEBPACK_IMPORTED_MODULE_1__[\"SphereGeometry\"](10);\n  addMesh(geo, scene, camera, new three__WEBPACK_IMPORTED_MODULE_1__[\"Vector3\"](0, 0, 0));\n  addMesh(geo, scene, camera, new three__WEBPACK_IMPORTED_MODULE_1__[\"Vector3\"](-200, 200, 0));\n  addMesh(geo, scene, camera, new three__WEBPACK_IMPORTED_MODULE_1__[\"Vector3\"](350, -150, 0));\n  addMesh(geo, scene, camera, new three__WEBPACK_IMPORTED_MODULE_1__[\"Vector3\"](350, -150, -600)); //平行光源オブジェクト(light)の設定\n\n  var ambientLight = new three__WEBPACK_IMPORTED_MODULE_1__[\"AmbientLight\"](0xffffff, 1.0);\n  scene.add(ambientLight);\n  renderer.render(scene, camera);\n};\n\nvar addMesh = function addMesh(geo, scene, camera, pos) {\n  var mesh = new three__WEBPACK_IMPORTED_MODULE_1__[\"Mesh\"](geo);\n  mesh.position.set(pos.x, pos.y, pos.z);\n  scene.add(mesh);\n  console.log(_bin_threejs_position_util__WEBPACK_IMPORTED_MODULE_0__[\"PositionUtil\"].get2DPositionWithMesh(mesh, camera, W, H));\n};\n/**\n * DOMContentLoaded以降に初期化処理を実行する\n */\n\n\nwindow.onload = onDomContentsLoaded;\n\n//# sourceURL=webpack:///./demoSrc/demo.js?");
